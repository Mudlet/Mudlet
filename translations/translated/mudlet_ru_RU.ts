...
%1</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>Не удалось экспортировать - не удалось открыть %1 для записи. Есть ли у вас необходимые разрешения на запись в эту папку?</translation>
    </message>
  </context>
  <context>
...
Повторите попытку, когда он будет завершен.</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>&lt;p&gt;Пользовательский (свой) словарь не будет использован в командной строке основного консоля. Луа команды, которые задают пользовательский словарь, вернут &lt;tt&gt;nil&lt;/t&gt; и &lt;i&gt;сообщение об ошибке&lt;/i&gt;.&lt;/p&gt;&lt;p&gt;Будет по-прежнему, однако, можно получить доступ к основному словарю, выбранному выше.&lt;/p&gt;</translation>
    </message>
    <message>
    ...
    <message>
      ...
      <translation>&lt;p&gt;Mudlet теперь выполняет некоторую проверку и исправления чтобы устранить проблемы, которые могли возникнуть в предыдущей версии из-за неисправного кода или плохо документированных команд.&lt;/p&gt;&lt;p&gt;Однако при обнаружении значительных проблем отчет может быть довольно обширным, особенно для больших карт. Чтобы уменьшить количество сообщений на экране, эта опция (если она не включена) приведет к тому, что большая часть текста не будет отображаться, за исключением предложения о просмотре &apos;&lt;b&gt;&lt;i&gt;./log/errors.txt&lt;/i&gt;&lt;/b&gt;&apos; файл в пакпе конкретного профиля, который будет содержать эквивалентные сведения и может быть указан в случае необходимости внесения изменений вручную.&lt;/p&gt;&lt;p&gt;&lt;i&gt;К этому файлу добавляется каждый отчет, который содержит дату и (в отличие от экранной версии, которая сообщает о проблемах по мере их возникновения) сортируется таким образом, чтобы вопросы, относящиеся к конкретной области карты или комнате, собирались в одной части каждого отчета.&lt;/i&gt;&lt;/p&gt;</translation>
    </message>
    <message>
...
&quot; to your command input on empty commands. This option will rarely be necessary.</source>
  ...
  <context>
    ...
    <message>
      ...
      <translation>&lt;p&gt;Оранжевая (закрытая) дверца будет нарисана на двухмерной карте (но не в данный момент).&lt;/p&gt;</translation>
    </message>
    <message>
