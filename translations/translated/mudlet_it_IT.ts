...
per aprire questo file hai bisogno dell'ultima versione di Mudlet!</translation>
  ...
  <context>
    ...
    <message>
      ...
      <translation>&lt;p&gt;scrivi uno o più comandi che si desidera che il pulsante invii direttamente al gioco se premuto. (Opzionale)&lt;/p&gt;&lt;p&gt;Se questo è un &lt;i&gt;push-down&lt;/i&gt; pulsante, questo viene inviato solo quando il pulsante va dal &lt;i&gt;fino&lt;/i&gt; per &lt;i&gt;giù&lt;/i&gt; stato.&lt;/p&gt;&lt;p&gt;Per inviare comandi più complessi, che potrebbe dipendere o necessità di modifica delle variabili all'interno di questo profilo di un Lua script deve essere inserito &lt;i&gt;invece&lt;/i&gt; nella lista qui sotto. Nulla qui inseriti, letteralmente, appena inviato al server di gioco.&lt;/p&gt;&lt;p&gt;è consentita per uso sia questo &lt;i&gt;e&lt;/i&gt; un Lua script verrà inviato &lt;b&gt;prima&lt;/b&gt; viene eseguito lo script.&lt;/p&gt;</translation>
    </message>
    <message>
