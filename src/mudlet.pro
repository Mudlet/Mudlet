...
LUA_TESTS.files = \
    ...
    $${PWD}/mudlet-lua/tests/DebugTools_spec.lua \
    $${PWD}/mudlet-lua/tests/GMCP_spec.lua \
    $${PWD}/mudlet-lua/tests/GUIUtils_spec.lua \
    $${PWD}/mudlet-lua/tests/IDManager_spec.lua \
    $${PWD}/mudlet-lua/tests/MudletBusted_spec.lua \
    $${PWD}/mudlet-lua/tests/Other_spec.lua \
    $${PWD}/mudlet-lua/tests/README.md \
    $${PWD}/mudlet-lua/tests/StringUtils_spec.lua \
    $${PWD}/mudlet-lua/tests/TableUtils_spec.lua \
    $${PWD}/mudlet-lua/tests/UI_spec.lua
LUA_TESTS.depends = mudlet

# Mappers' files:
LUA_GENERIC-MAPPER = \
    $${PWD}/mudlet-lua/tests/UI_spec.lua
    lua/generic-mapper/generic_mapper.xml
