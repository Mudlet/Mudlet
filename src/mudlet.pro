...
if(lessThan(QT_MAJOR_VERSION,6)) {
    error("Mudlet requires Qt 6.2.4 or later")
}
if(equals(QT_MAJOR_VERSION,6):lessThan(QT_MINOR_VERSION,2)) {
    error("Mudlet requires Qt 6.2.4 or later")
}
if(equals(QT_MAJOR_VERSION,6):equals(QT_MINOR_VERSION,2):lessThan(QT_PATCH_VERSION,4)) {
    error("Mudlet requires Qt 6.2.4 or later")
}
