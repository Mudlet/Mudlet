...
void cTelnet::autoEnableMXPProcessor()
{
    ...
    postMessage(tr("[ INFO ]  - This game appears to support MXP (Mud eXtension Protocol), but hasn't turned it on properly. MXP processing has been automatically enabled in secure mode for full compatibility with clickable links, room info, and richer interactions. You can disable this setting in Settings > Special Options."));
}
