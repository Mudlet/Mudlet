...
, mIsBackground(isBackGround)
{
    ...
    buttonBox->button(QDialogButtonBox::Apply)->setToolTip(mudlet::htmlWrapper(tr("Click to access all 256 ANSI colors.")));
...
void dlgColorTrigger::slot_moreColorsClicked()
{
    ...
    buttonBox->button(QDialogButtonBox::Apply)->setToolTip(mudlet::htmlWrapper(tr("All color options are showing.")));
