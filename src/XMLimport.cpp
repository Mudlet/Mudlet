...
void XMLimport::readUnknownTriggerElement()
{
    while( ! atEnd() )
    {
        ...
        readNext();
        qDebug().nospace() << "XMLimport::readUnknownTriggerElement() ERROR: UNKNOWN Trigger Package Element, name: "
                           << name().toString()
                           << " and content: "
                           << text().toString();
...
void XMLimport::readUnknownTimerElement()
{
    while( ! atEnd() )
    {
        ...
        readNext();
        qDebug().nospace() << "XMLimport::readUnknownTimerElement() ERROR: UNKNOWN Timer Package Element, name: "
                           << name().toString()
                           << " and content: "
                           << text().toString();
...
void XMLimport::readUnknownAliasElement()
{
    while( ! atEnd() )
    {
        ...
        readNext();
        qDebug().nospace() << "XMLimport::readUnknownAliasElement() ERROR: UNKNOWN Alias Package Element, name: "
                           << name().toString()
                           << " and content: "
                           << text().toString();
...
void XMLimport::readUnknownActionElement()
{
    while( ! atEnd() )
    {
        ...
        readNext();
        qDebug().nospace() << "XMLimport::readUnknownActionElement() ERROR: UNKNOWN Action Package Element, name: "
                           << name().toString()
                           << " and content: "
                           << text().toString();
...
void XMLimport::readUnknownScriptElement()
{
    while( ! atEnd() )
    {
        ...
        readNext();
        qDebug().nospace() << "XMLimport::readUnknownScriptElement() ERROR: UNKNOWN Script Package Element, name: "
                           << name().toString()
                           << " and content: "
                           << text().toString();
...
void XMLimport::readUnknownKeyElement()
{
    while( ! atEnd() )
    {
        ...
        readNext();
        qDebug().nospace() << "XMLimport::readUnknownKeyElement() ERROR: UNKNOWN Key Package Element, name: "
                           << name().toString()
                           << " and content: "
                           << text().toString();
