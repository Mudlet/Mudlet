...
const QStringList TLinkStore::getCurrentLinks() const
{
...
const QStringList TLinkStore::getLinks(int id) const
{
    return mLinkStore[id];
}

const QStringList TLinkStore::getHints(int id) const
{
