...
void TDetachedWindow::updateWindowTitle()
{
    ...
    if (mProfileConsoleMap.size() == 1) {
        ...
        //: This is the title of a Mudlet window which was detached from the main Mudlet window, and has multiple profile opened. %1 is the number of profiles, %2 is the name of the profile currently shown.
