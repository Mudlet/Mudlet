...
{
    // Not mudlet::getQSettings(), which needs mudlet::self(): a --help or --version run never creates the
    // singleton. Same file and format as setupConfig() opens - keep the spellings in step.
