...
int main(int argc, char* argv[])
{
    ...
    // handler!) This is reflected in the use of dummyInternalOptionString
    // and dummyVersionString below for some later entries.
    ...
    // version string i.e. "1.2.3[.4]" or "1.2.3[.4][_rc5]") then the option is
    // disregarded by the parser:
    QCommandLineOption installRun(QStringList() << qsl("squirrel-install"), dummyInternalOptionString, dummyVersionString);
    parser.addOption(installRun);

    QCommandLineOption updateRun(QStringList() << qsl("squirrel-updated"), dummyInternalOptionString, dummyVersionString);
    parser.addOption(updateRun);

    QCommandLineOption obsoleteRun(QStringList() << qsl("squirrel-obsolete"), dummyInternalOptionString, dummyVersionString);
    parser.addOption(obsoleteRun);

    QCommandLineOption uninstallRun(QStringList() << qsl("squirrel-uninstall"), dummyInternalOptionString, dummyVersionString);
