...
// Not sure about MacOS case as that does not use X
    ...
    if (show_splash) {
        ...
        QString sourceVersionText = QString(tr("Version: ") APP_VERSION APP_BUILD);
