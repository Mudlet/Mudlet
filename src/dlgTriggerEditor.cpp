...
, mVarEditorSplitterState{}
{
    ...
    deleteTriggerAction->setToolTip(qsl("<html><head/><body><p>%1 (%2)</p></body></html>").arg(tr("Delete Item"), QKeySequence(QKeySequence::Delete).toString()));
    ...
    saveAction->setToolTip(qsl("<html><head/><body><p>%1</p></body></html>")
    ...
    mProfileSaveAction->setToolTip(
            qsl("<html><head/><body><p>%1</p></body></html>")
    ...
    mpAction_searchCaseSensitive->setToolTip(qsl("<p>%1</p>")
    ...
    mpAction_searchIncludeVariables->setToolTip(qsl("<p>%1</p>")
