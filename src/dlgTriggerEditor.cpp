...
void dlgTriggerEditor::createPatternItem(int index)
{
    ...
    pItem->singleLineTextEdit_pattern->setAccessibleDescription(tr("Use Ctrl+Shift+Up to jump to first pattern, Ctrl+Shift+Down to jump to last pattern, Ctrl+Up/Down to move between patterns"));
}
