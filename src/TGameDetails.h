...
qsl("<a href='https://abandonedrealms.com'>Website</a><br>"
            ...
            qsl("The Abandoned Realms is a completely free RP-enforced, PK-encouraged, MUD in a fantasy setting "
                 ...
                 "16 classes, there are vast possibilities for players to explore and enjoy. The Abandoned Realms has a "
                 "dedicated staff of highly skilled immortals/coders/builders, and a diverse base players online at any "
                 "given time. There are extensive opportunities for role-play, including writing character background "
                 "entries, building your own house (including decor), contributing to the in-game newspaper, engaging in "
                 "political intrigue, choosing a deity to worship (and opening exceptional Immortal RP opportunities), and "
                 "more.\n\nIt is a dangerous realm, filled with exceptional killers but new players are not hunted – they "
                 "are welcomed and supported. Perma-death exists, but it is common for characters to live for hundreds of "
                 "hours, or as long as the player desires. Information and advice are shared freely – see The Codex for item "
                 "identifications/locations, the logboard for battles, and the forum and discord for gameplay discussion and "
                 ...
                 "opportunity to leave your lasting mark and be remembered forever, then welcome ye to the Abandoned Realms.")
            },
            {qsl("Avalon.de"), // Name
