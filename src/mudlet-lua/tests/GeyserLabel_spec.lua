...
describe("Tests functionality of Geyser.Label widget state", function()
  ...
  describe("Geyser.Label:new/new2", function()
    ...
    it("starts out hidden when the constraints ask for it", function()
      local label =
        track(Geyser.Label:new({ name = "glsHiddenNew", x = 0, y = 0, width = 40, height = 20, hidden = true }))
    ...
    it("starts out hidden when new2 constraints ask for it", function()
      local label =
        track(Geyser.Label:new2({ name = "glsHiddenNew2", x = 0, y = 0, width = 40, height = 20, hidden = true }))
      assert.is_true(label.hidden)
    ...
    it("starts out hidden when the constraints ask for auto_hidden", function()
      local label = track(
        Geyser.Label:new({ name = "glsAutoHiddenNew", x = 0, y = 0, width = 40, height = 20, auto_hidden = true })
      )
  ...
  describe(
    "Geyser.Label:getSizeHint and Geyser.Label auto-size adjustSize/adjustHeight/adjustWidth/autoAdjustSize/enableAutoAdjustSize/disableAutoAdjustSize",
    function()
      local label
...
describe("Tests Geyser.Label movies, callbacks and nesting", function()
  ...
  local function writeAnimatedGif(path)
    local bytes = {
      ...
      0x80,
      0x00,
      0x00, -- 1x1, global colour table of 2
      0x00,
      0x00,
      0x00,
      0xFF,
  ...
  describe("Geyser.Label movie wrappers", function()
    ...
    it("the movie functions all refuse a label with no movie on it", function()
      ...
      for _, call in ipairs({
        function()
          return bare:startMovie()
        end,
        function()
          return bare:pauseMovie()
        end,
        function()
          return bare:setMovieSpeed(200)
        end,
        function()
          return bare:setMovieFrame(0)
        end,
        function()
          return bare:scaleMovie()
        end,
      }) do
  ...
  describe("Geyser.Label callback registration", function()
    ...
    it("registers the callbacks the constructor was given", function()
      local built = track(Geyser.Label:new({
        ...
        clickCallback = "echo",
        clickArgs = { "hello" },
        doubleClickCallback = "echo",
        doubleClickArgs = "hello",
        onEnter = "echo",
        onEnterArgs = "hello",
      }, container))
  ...
  describe("Geyser.Label:addChild", function()
    ...
    it("splits layoutDir into a fly direction and a layout axis", function()
      local child =
        track(parent:addChild({ name = "glnChildRH", width = 50, height = 20, layoutDir = "RH" }, container))
    ...
    it("gives a nestable label the click callback that opens its nest", function()
      local nestable = track(
        Geyser.Label:new({ name = "glnNestable", x = 0, y = 0, width = 50, height = 20, nestable = true }, container)
      )
    ...
    it("gives a nestflyout label the hover callback that opens its nest", function()
      local flyout = track(
        Geyser.Label:new({ name = "glnFlyout", x = 0, y = 0, width = 50, height = 20, nestflyout = true }, container)
      )
  ...
  describe("Geyser.Label nest display and closing", function()
    ...
    it("displayNest stacks a second child below the first", function()
      local second =
        track(parent:addChild({ name = "glnNestChildTwo", width = 50, height = 20, layoutDir = "RV" }, container))
      parent:displayNest()
    ...
    it("displayNest lays a horizontal nest out sideways instead", function()
      ...
      local first =
        track(parent:addChild({ name = "glnNestSideways", width = 50, height = 20, layoutDir = "RH" }, container))
      local second =
        track(parent:addChild({ name = "glnNestSidewaysTwo", width = 50, height = 20, layoutDir = "RH" }, container))
      parent:displayNest()
    ...
    it("closeAllLevels hides every nested label in the container", function()
      local other =
        track(Geyser.Label:new({ name = "glnOtherParent", x = 300, y = 100, width = 50, height = 20 }, container))
  ...
  describe("Geyser.Label:addScrollbars and doNestScroll", function()
    ...
    before_each(function()
      parent =
        track(Geyser.Label:new({ name = "glnScrollParent", x = 100, y = 100, width = 50, height = 20 }, container))
    ...
    local function makeScrollbars()
      ...
      Geyser.Label.scrollV[parent] = bars
        ...
        Geyser.Label.scrollV[parent] = nil
      end)
...
describe("Tests Geyser.Label font, link style and tooltip", function()
  ...
  describe("Geyser.Label:setFont", function()
    ...
    it("warns but still takes a family the font database does not list", function()
      ...
      local ok, err
      assert.has_no.errors(function()
        ok, err = label:setFont("No Such Font At All")
      end)
      assert.is_true(ok)
      assert.is_nil(err)
    ...
    it("does not raise when the constructor is handed a font that is not a string", function()
      ...
      assert.has_no.errors(function()
        built =
          track(Geyser.Label:new({ name = "glfFontNotAString", x = 0, y = 60, width = 200, height = 50, font = 12 }))
      end)
    ...
    it("normalises a font constraint that is present but false", function()
      ...
      local built =
        track(Geyser.Label:new({ name = "glfFontFalse", x = 0, y = 240, width = 200, height = 50, font = false }))
      assert.are.equal("", built.font)
    ...
    it("keeps a child's own font off the label it was cloned from", function()
      ...
      prototype:setFont("Ubuntu Mono")
      local child = track(prototype:new({
        name = "glfOwnChild",
        x = 0,
        y = 360,
        width = 200,
  ...
  describe("Geyser.Label:setLinkStyle/resetLinkStyle/clearVisitedLinks", function()
    ...
    pending(
      "Geyser.Label:setLinkStyle reporting whether the styling reached the label - the three wrappers discard the nil and error message their global answers with, and Mudlet has no link style getter"
    )
  end)
...
describe("Tests Geyser.Label right click menus", function()
  ...
  describe("Geyser.Label:setMenuAction", function()
    ...
    it("raises for an item that is not in the menu", function()
      local ok, message = pcall(function()
        label:setMenuAction("Nowhere", function() end)
      end)
      assert.is_false(ok)
  ...
  describe("Geyser.Label:hideMenuLabel/showMenuLabel", function()
    ...
    it("raises for an item that is not in the menu", function()
      assert.has_error(function()
        label:hideMenuLabel("Nowhere")
      end)
      assert.has_error(function()
        label:showMenuLabel("Nowhere")
      end)
    end)
  end)
  ...
  describe("Geyser.Label:changeMenuIndex", function()
    ...
    it("raises for an item that is not in the menu", function()
      assert.has_error(function()
        label:changeMenuIndex("Nowhere", 1)
      end)
    end)
  end)
