...
describe("Tests functionality of Geyser.UserWindow", function()
  ...
  describe("Geyser.UserWindow:new/new2", function()
    ...
    it("gives itself a root container sized to the user window", function()
      ...
      assert.is_true(
        usableWidth > 0 and usableWidth <= dock.width,
        string.format("usable width %d is not inside the dock width %d", usableWidth, dock.width)
      )
      assert.is_true(
        usableHeight > 0 and usableHeight <= dock.height,
      ...
      if not dockDecoratedByWindowManager then
        assert.is_true(
          ...
          string.format(
            "Qt draws the dock title bar here, so it must cost height: usable %d, dock %d",
            usableHeight,
            dock.height
          )
        )
    ...
    it("defaults to an undocked, auto docking window that does not restore a layout", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwDefaults", x = 10, y = 10, width = 200, height = 150 }))
    ...
    it("takes the font family it was given", function()
      local userWindow = track(
        Geyser.UserWindow:new({ name = "guwFamily", x = 10, y = 10, width = 250, height = 180, font = "Ubuntu Mono" })
      )
    ...
    it("ignores the geometry it was given when it is asked to start docked", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwDocked", x = 10, y = 10, width = 300, height = 200, docked = true }))
    ...
    it("starts out hidden when the constraints ask for it, and shows again", function()
      local userWindow = track(
        Geyser.UserWindow:new({ name = "guwHiddenNew", x = 10, y = 10, width = 200, height = 150, hidden = true })
      )
  ...
  describe("Geyser.UserWindow:move/resize", function()
    ...
    it("re-resolves the size of percentage children when it is resized", function()
      ...
      assert.are.same(
        { x = 0, y = 0, width = math.floor(firstWidth / 2), height = firstHeight },
        geometry("guwMoveChild")
      )
      userWindow:resize(400, 260)
      local secondWidth, secondHeight = getUserWindowSize("guwMove")
      assert.is_true(secondWidth > firstWidth)
      assert.are.same(
        { x = 0, y = 0, width = math.floor(secondWidth / 2), height = secondHeight },
        geometry("guwMoveChild")
      )
    end)
  end)
  ...
  describe("Geyser.UserWindow children", function()
    ...
    it("creates children inside the user window, sized against its usable area", function()
      local label =
        track(Geyser.Label:new({ name = "guwLabel", x = "50%", y = 0, width = "50%", height = "100%" }, userWindow))
    ...
    it("holds a scroll box, which becomes a parent window inside it", function()
      local scrollBox =
        track(Geyser.ScrollBox:new({ name = "guwScrollBox", x = 0, y = 0, width = "100%", height = "50%" }, userWindow))
      ...
      local usableWidth, usableHeight = getUserWindowSize("guwHolder")
      assert.are.same(
        { x = 0, y = 0, width = usableWidth, height = math.floor(usableHeight / 2) },
        geometry("guwScrollBox")
      )
      -- and a child of the scroll box is placed in the scroll box's own space
      local label =
        track(Geyser.Label:new({ name = "guwScrollBoxLabel", x = 0, y = 0, width = "50%", height = "100%" }, scrollBox))
  ...
  describe("Geyser.UserWindow:hide/show", function()
    ...
    it("hides the children in it along with the dock", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwHideChild", x = 10, y = 20, width = 200, height = 150 }))
  ...
  describe("Geyser.UserWindow show cascade", function()
    it("stays hidden when its root container is shown after a hand hide", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwHandHidden", x = 10, y = 20, width = 200, height = 150 }))
      userWindow:hide()
      assert.is_true(userWindow.hidden)
    ...
    it("comes back when the container that hid it is shown again", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwAutoHidden", x = 10, y = 20, width = 200, height = 150 }))
  ...
  describe("Geyser.UserWindow:setTitle/resetTitle", function()
    ...
    it("remembers the title it was given, and empties it again on reset", function()
      local userWindow = track(
        Geyser.UserWindow:new({ name = "guwTitle", x = 10, y = 20, width = 200, height = 150, titleText = "My window" })
      )
    ...
    it("starts with an empty title when it was not given one", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwNoTitle", x = 10, y = 20, width = 200, height = 150 }))
      assert.are.equal("", userWindow.titleText)
    end)
  end)

  pending(
    "Geyser.UserWindow:setTitle/resetTitle put the text on the dock's title bar - needs a getUserWindowTitle getter"
  )
  ...
  pending(
    "Geyser.UserWindow scrollBar constraint puts a scroll bar on screen - the wrap it leaves room for is covered above, but the scroll bar's own visibility is not readable from Lua and needs a scroll bar getter"
  )
  ...
  describe("Geyser.UserWindow:enableAutoDock/disableAutoDock", function()
    it("turns automatic docking off and on again without disturbing the window", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwAutoDock", x = 10, y = 20, width = 300, height = 200 }))
  ...
  describe("Geyser.UserWindow:setDockPosition", function()
    ...
    local function floatAgain(userWindow)
      undo[#undo + 1] = function()
        userWindow:setDockPosition("floating")
      end
    end
    ...
    it("records the position and reopens the window at it", function()
      ...
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwDockPos", x = 10, y = 20, width = 200, height = 150 }))
    ...
    it("docks a window whose automatic docking is turned off", function()
      local openWindow = watchOpenUserWindow()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwDockNoAuto", x = 10, y = 20, width = 200, height = 150 }))
      floatAgain(userWindow)
    ...
    it("floats a docked window again", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwFloatBack", x = 10, y = 20, width = 200, height = 150 }))
      floatAgain(userWindow)
    ...
    it("brings a hidden window back with it rather than leaving it half hidden", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwDockHidden", x = 10, y = 20, width = 200, height = 150 }))
      floatAgain(userWindow)
      userWindow:hide()
    ...
    it("leaves a window it brought back hideable again", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwDockRehide", x = 10, y = 20, width = 200, height = 150 }))
      floatAgain(userWindow)
      userWindow:hide()
      userWindow:setDockPosition("right")
    ...
    it("brings the children of a hidden window back with it", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwDockChild", x = 10, y = 20, width = 200, height = 150 }))
      floatAgain(userWindow)
      local label = track(
        Geyser.Label:new({ name = "guwDockChildLabel", x = 0, y = 0, width = "100%", height = "100%" }, userWindow)
      )
      userWindow:hide()
    ...
    it("leaves a window that was never hidden alone", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwDockVisible", x = 10, y = 20, width = 200, height = 150 }))
      floatAgain(userWindow)
    ...
    it("leaves a child that was put away by hand where it is", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwDockVisibleChild", x = 10, y = 20, width = 200, height = 150 }))
      floatAgain(userWindow)
      local label =
        track(Geyser.Label:new({ name = "guwDockHandHidden", x = 0, y = 0, width = "50%", height = "50%" }, userWindow))
      label:hide()
      userWindow:hide()
    ...
    it("clears the flag the window put on itself, not the one its container put there", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwDockAutoHidden", x = 10, y = 20, width = 200, height = 150 }))
      floatAgain(userWindow)
      userWindow:hide()
      userWindow.container:hide()
  ...
  pending(
    "Geyser.UserWindow:setDockPosition docking the window against the edge it names - which edge a user window ended up docked to, and whether it docks by itself when dragged, are not readable from Lua"
  )
  ...
  describe("Geyser.UserWindow:delete", function()
    ...
    it("takes its dock widget with it, so nothing stale answers for the name", function()
      ...
      assert.is_true(
        getUserWindowSize("guwReopen") < mainWidth,
        "a user window that reports the main window's size has no dock of its own"
      )
  ...
  describe("Geyser.UserWindow root container cleanup", function()
    it("removes the root container it created", function()
      local trackedWindows = #Geyser.windows
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwRootGone", x = 10, y = 20, width = 200, height = 150 }))
    ...
    it("leaves a root container that still holds something else", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwRootShared", x = 10, y = 20, width = 200, height = 150 }))
    ...
    it("removes the root container even after the user window was moved out of it", function()
      ...
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwMovedOut", x = 10, y = 20, width = 200, height = 150 }))
    ...
    it("comes apart cleanly when the root container is the one deleted", function()
      local userWindow =
        track(Geyser.UserWindow:new({ name = "guwRootKept", x = 10, y = 20, width = 200, height = 150 }))
      local root = userWindow.container
...
describe("Tests Geyser.UserWindow:set_uwconstr", function()
  ...
  it("resolves pixels as pixels", function()
    local userWindow =
      track(Geyser.UserWindow:new({ name = "guwConstrPixels", x = 10, y = 20, width = 200, height = 150 }))
  ...
  it("is undone by resetWindow, which sizes the window against itself again", function()
    local userWindow =
      track(Geyser.UserWindow:new({ name = "guwConstrReset", x = 10, y = 20, width = 200, height = 150 }))
  ...
  it("is what move and resize position the dock with", function()
    local userWindow =
      track(Geyser.UserWindow:new({ name = "guwConstrMove", x = 10, y = 20, width = 200, height = 150 }))
