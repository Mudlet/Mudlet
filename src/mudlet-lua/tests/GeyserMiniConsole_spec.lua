...
describe("Tests functionality of Geyser.MiniConsole", function()
  ...
  describe("Geyser.MiniConsole:new and Geyser.MiniConsole:new2", function()
  ...
  describe("Geyser.MiniConsole:setWrap and the auto wrap family", function()
    ...
    it("refuses to set the wrap while auto wrap is on", function()
      ...
      assert.are_not.equal(11, getWindowWrap("gmcWrapLocked"))
    end)
  ...
  describe("Geyser.MiniConsole:setFontSize and Geyser.MiniConsole:getFont", function()
    ...
    it("reports the font family in use", function()
      local console = track(Geyser.MiniConsole:new({name = "gmcFontFamily", x = 0, y = 0, width = 300, height = 100}))
      assert.are.equal(getFont("gmcFontFamily"), console:getFont())
      assert.are.equal(console.font, getFont("gmcFontFamily"))
    end)
  end)
  ...
  describe("Geyser.MiniConsole:type_delete", function()
    it("deletes the widget with the object", function()
      local console = Geyser.MiniConsole:new({name = "gmcDelete", x = 0, y = 0, width = 100, height = 50})
