-- Contract-only specs for the networking, MMCP and Discord APIs. The media
-- contracts that used to be here now live in Media_spec.lua.
--
...
-- Those effects are covered by separate, stub-backed work.
...
-- a socket or issues an HTTP request.
