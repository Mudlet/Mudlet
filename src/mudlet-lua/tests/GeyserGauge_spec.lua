...
describe("Tests functionality of Geyser.Gauge", function()
  ...
  describe("Geyser.Gauge:new/new2", function()
    ...
    it("starts out hidden when the constraints ask for it, and shows again", function()
      local gauge =
        track(Geyser.Gauge:new({ name = "ggsHiddenNew", x = 0, y = 0, width = 100, height = 20, hidden = true }))
  ...
  describe("Geyser.Gauge:setValue", function()
    ...
    it("caps a strict gauge at its own width", function()
      local strict =
        track(Geyser.Gauge:new({ name = "ggsStrict", x = 0, y = 0, width = 200, height = 40, strict = true }))
      strict:setValue(150)
    ...
    it("stays full over repeated overflow and comes back down", function()
      local strict =
        track(Geyser.Gauge:new({ name = "ggsStrictRepeat", x = 0, y = 0, width = 200, height = 40, strict = true }))
      strict:setValue(150)
      strict:setValue(300)
  ...
  describe("Geyser.Gauge orientations", function()
    it("fills a vertical gauge from the bottom", function()
      local gauge = track(
        Geyser.Gauge:new({ name = "ggsVertical", x = 0, y = 0, width = 100, height = 200, orientation = "vertical" })
      )
      gauge:setValue(25)
    ...
    it("fills a goofy gauge from the right", function()
      local gauge =
        track(Geyser.Gauge:new({ name = "ggsGoofy", x = 0, y = 0, width = 200, height = 40, orientation = "goofy" }))
      gauge:setValue(25)
    ...
    it("fills a batty gauge from the top", function()
      local gauge =
        track(Geyser.Gauge:new({ name = "ggsBatty", x = 0, y = 0, width = 100, height = 200, orientation = "batty" }))
      gauge:setValue(25)
  ...
  describe("Geyser.Gauge:setStyleSheet", function()
    ...
    it("reads a margin inside a selector block without wrecking the sheet", function()
      ...
      gauge:setStyleSheet(
        "QLabel { background-color: red; margin: 4px }",
        "QLabel { background-color: blue; margin: 4px }"
      )
    ...
    it("does not read a commented out margin, and leaves the comment whole", function()
      ...
      gauge:setStyleSheet(
        "background-color: red; /* margin: 20px */ padding: 3px;",
        "background-color: blue; /* margin: 20px */ padding: 3px;"
      )
    ...
    it("keeps a negative margin in every orientation", function()
      ...
      for orientation, geometryWanted in pairs(expected) do
        ...
        local gauge =
          track(Geyser.Gauge:new({ name = name, x = 20, y = 20, width = 200, height = 100, orientation = orientation }))
        gauge:setStyleSheet("margin: -5px;", "margin: -5px;")
        gauge:setValue(100)
    ...
    it("says nothing about an ordinary borderless stylesheet", function()
      ...
      gauge:setStyleSheet(
        "border: none; background-color: red; margin: 0;",
        "border: none; background-color: blue; margin: 0;"
      )
  ...
  describe("Geyser.Gauge geometry and visibility", function()
    ...
    it("sizes a percentage gauge against its container", function()
      ...
      local gauge =
        track(Geyser.Gauge:new({ name = "ggsInBox", x = 0, y = 0, width = "50%", height = "100%" }, container))
      gauge:setValue(50)
