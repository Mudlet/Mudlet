...
describe("Tests UI functions", function()
  ...
  -- https://github.com/Mudlet/Mudlet/issues/823
  -- Label callback functions should accept nil to clear callbacks
  describe("Test label callback functions accept nil (#823)", function()
    setup(function()
      createLabel("testLabel823", 100, 100, 100, 30, 1)
    end)

    teardown(function()
      hideWindow("testLabel823")
    end)

    it("Should accept a function for setLabelClickCallback", function()
      local success = pcall(function()
        setLabelClickCallback("testLabel823", function() end)
      end)
      assert.is_true(success)
    end)

    it("Should accept nil to clear setLabelClickCallback", function()
      -- First set a callback
      setLabelClickCallback("testLabel823", function() end)
      -- Then clear it with nil
      local success = pcall(function()
        setLabelClickCallback("testLabel823", nil)
      end)
      assert.is_true(success)
    end)

    it("Should reject boolean for setLabelClickCallback", function()
      local success = pcall(function()
        setLabelClickCallback("testLabel823", true)
      end)
      assert.is_false(success)
    end)

    it("Should accept nil to clear setLabelOnEnter", function()
      setLabelOnEnter("testLabel823", function() end)
      local success = pcall(function()
        setLabelOnEnter("testLabel823", nil)
      end)
      assert.is_true(success)
    end)

    it("Should accept nil to clear setLabelOnLeave", function()
      setLabelOnLeave("testLabel823", function() end)
      local success = pcall(function()
        setLabelOnLeave("testLabel823", nil)
      end)
      assert.is_true(success)
    end)

    it("Should accept nil to clear setLabelReleaseCallback", function()
      setLabelReleaseCallback("testLabel823", function() end)
      local success = pcall(function()
        setLabelReleaseCallback("testLabel823", nil)
      end)
      assert.is_true(success)
    end)

    it("Should reject string for setLabelClickCallback", function()
      local success = pcall(function()
        setLabelClickCallback("testLabel823", "not a function")
      end)
      assert.is_false(success)
    end)

    it("Should reject number for setLabelClickCallback", function()
      local success = pcall(function()
        setLabelClickCallback("testLabel823", 123)
      end)
      assert.is_false(success)
    end)
  end)
