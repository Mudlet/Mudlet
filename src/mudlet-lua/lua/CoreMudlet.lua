...
if false then
  ...
  --- @see copy
  --- @see echo
  function appendBuffer(windowName)
  end
  ...
  function clearUserWindow(windowName)
  end
  ...
  ---
  --- @return true or false
  function createMiniConsole(name, posX, posY, width, height)
  end
  ...
  function invokeFileDialog(selection, dialogTitle)
  end
  ...
  ---
  --- @see exists
  function permAlias(name, parent, regex, luaCode)
  end
  ...
  ---   </pre>
  function permBeginOfLineStringTrigger(name, parent, patternTable, luaCode)
  end
  ...
  ---
  --- @see exists
  function permRegexTrigger(name, parent, pattern, luaCode)
  end
  ...
  ---
  --- @see exists
  function permSubstringTrigger(name, parent, pattern, luaCode)
  end
  ...
  ---   </pre>
  function permTimer(name, parent, seconds, luaCode)
  end
  ...
  ---
  --- @param windowName optional
  function resetFormat(windowName)
  end
  ...
  function setBackgroundColor(windowName, red, green, blue, transparency)
  end



  -- Loads an image file (png) as a background image for a label. This can be used to display clickable images etc.
  function setBackgroundImage(labelName, imageFileName)
  end
  ...
  ---
  --- @param windowName optional
  function setBold(windowName, bool)
  end
  ...
  function setLabelClickCallback(labelName, luaFunctionName, ...)
  end
  ...
  --- @see echoLink
  --- @see insertLink
  function setLink(command, tooltip)
  end
  ...
  function setPopup(name, commands, hints)
  end
  ...
  --- @see setItalics
  --- @see setUnderline
  function setTextFormat(windowName, fgR, fgG, fgB, bgR, bgG, bgB, bold, underline, italics)
  end
  ...
  ---
  --- @return id
  function tempAlias(regex, luaCode)
  end
  ...
  ---   </pre>
  function tempColorTrigger(foregroundColor, backgqroundColor, luaCode)
  end
  ...
  ---   </pre>
  function tempLineTrigger(from, howMany, luaCode)
  end
  ...
  --- @see killTrigger
  --- @see tempTrigger
  function tempRegexTrigger(regex, luaCode)
  end
  ...
  function tempTimer(seconds, luaCode)
  end
  ...
  function tempTrigger(string, luaCode)
  end
