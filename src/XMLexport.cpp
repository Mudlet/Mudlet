...
void XMLexport::writeHost(Host* pHost, pugi::xml_node mudletPackage)
{
    ...
    { // Blocked so that indentation reflects that of the XML file
        ...
        host.append_child("mBlack").text().set(pHost->mColorScheme.mBlack.name().toUtf8().constData());
        host.append_child("mLightBlack").text().set(pHost->mColorScheme.mLightBlack.name().toUtf8().constData());
        host.append_child("mRed").text().set(pHost->mColorScheme.mRed.name().toUtf8().constData());
        host.append_child("mLightRed").text().set(pHost->mColorScheme.mLightRed.name().toUtf8().constData());
        host.append_child("mBlue").text().set(pHost->mColorScheme.mBlue.name().toUtf8().constData());
        host.append_child("mLightBlue").text().set(pHost->mColorScheme.mLightBlue.name().toUtf8().constData());
        host.append_child("mGreen").text().set(pHost->mColorScheme.mGreen.name().toUtf8().constData());
        host.append_child("mLightGreen").text().set(pHost->mColorScheme.mLightGreen.name().toUtf8().constData());
        host.append_child("mYellow").text().set(pHost->mColorScheme.mYellow.name().toUtf8().constData());
        host.append_child("mLightYellow").text().set(pHost->mColorScheme.mLightYellow.name().toUtf8().constData());
        host.append_child("mCyan").text().set(pHost->mColorScheme.mCyan.name().toUtf8().constData());
        host.append_child("mLightCyan").text().set(pHost->mColorScheme.mLightCyan.name().toUtf8().constData());
        host.append_child("mMagenta").text().set(pHost->mColorScheme.mMagenta.name().toUtf8().constData());
        host.append_child("mLightMagenta").text().set(pHost->mColorScheme.mLightMagenta.name().toUtf8().constData());
        host.append_child("mWhite").text().set(pHost->mColorScheme.mWhite.name().toUtf8().constData());
        host.append_child("mLightWhite").text().set(pHost->mColorScheme.mLightWhite.name().toUtf8().constData());
        ...
        host.append_child("mFgColor2").text().set(pHost->mFgColor.name().toUtf8().constData());
        host.append_child("mBgColor2").text().set(pHost->mBgColor.name().toUtf8().constData());
        host.append_child("mBlack2").text().set(pHost->mColorScheme2.mBlack.name().toUtf8().constData());
        host.append_child("mLightBlack2").text().set(pHost->mColorScheme2.mLightBlack.name().toUtf8().constData());
        host.append_child("mRed2").text().set(pHost->mColorScheme2.mRed.name().toUtf8().constData());
        host.append_child("mLightRed2").text().set(pHost->mColorScheme2.mLightRed.name().toUtf8().constData());
        host.append_child("mBlue2").text().set(pHost->mColorScheme2.mBlue.name().toUtf8().constData());
        host.append_child("mLightBlue2").text().set(pHost->mColorScheme2.mLightBlue.name().toUtf8().constData());
        host.append_child("mGreen2").text().set(pHost->mColorScheme2.mGreen.name().toUtf8().constData());
        host.append_child("mLightGreen2").text().set(pHost->mColorScheme2.mLightGreen.name().toUtf8().constData());
        host.append_child("mYellow2").text().set(pHost->mColorScheme2.mYellow.name().toUtf8().constData());
        host.append_child("mLightYellow2").text().set(pHost->mColorScheme2.mLightYellow.name().toUtf8().constData());
        host.append_child("mCyan2").text().set(pHost->mColorScheme2.mCyan.name().toUtf8().constData());
        host.append_child("mLightCyan2").text().set(pHost->mColorScheme2.mLightCyan.name().toUtf8().constData());
        host.append_child("mMagenta2").text().set(pHost->mColorScheme2.mMagenta.name().toUtf8().constData());
        host.append_child("mLightMagenta2").text().set(pHost->mColorScheme2.mLightMagenta.name().toUtf8().constData());
        host.append_child("mWhite2").text().set(pHost->mColorScheme2.mWhite.name().toUtf8().constData());
        host.append_child("mLightWhite2").text().set(pHost->mColorScheme2.mLightWhite.name().toUtf8().constData());
