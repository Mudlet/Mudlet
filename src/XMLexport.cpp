...
void XMLexport::writeHost(Host* pHost, pugi::xml_node mudletPackage)
{
    ...
    // append attribute for enum blankLineBehaviour
    host.append_attribute("blankLineBehaviour") = QVariant::fromValue(pHost->mBlankLineBehaviour).toString().toLatin1().constData();
