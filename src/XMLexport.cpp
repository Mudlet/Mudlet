...
void XMLexport::writeHost(Host* pHost, pugi::xml_node mudletPackage)
{
    ...
    { // Blocked so that indentation reflects that of the XML file
        ...
        host.append_child("mLightRed").text().set(pHost->mColorSettings.mLightRed.name().toUtf8().constData());
        host.append_child("mBlue").text().set(pHost->mColorSettings.mBlue.name().toUtf8().constData());
        host.append_child("mLightBlue").text().set(pHost->mColorSettings.mLightBlue.name().toUtf8().constData());
        host.append_child("mGreen").text().set(pHost->mColorSettings.mGreen.name().toUtf8().constData());
        host.append_child("mLightGreen").text().set(pHost->mColorSettings.mLightGreen.name().toUtf8().constData());
        host.append_child("mYellow").text().set(pHost->mColorSettings.mYellow.name().toUtf8().constData());
        host.append_child("mLightYellow").text().set(pHost->mColorSettings.mLightYellow.name().toUtf8().constData());
        host.append_child("mCyan").text().set(pHost->mColorSettings.mCyan.name().toUtf8().constData());
        host.append_child("mLightCyan").text().set(pHost->mColorSettings.mLightCyan.name().toUtf8().constData());
        host.append_child("mMagenta").text().set(pHost->mColorSettings.mMagenta.name().toUtf8().constData());
        host.append_child("mLightMagenta").text().set(pHost->mColorSettings.mLightMagenta.name().toUtf8().constData());
        host.append_child("mWhite").text().set(pHost->mColorSettings.mWhite.name().toUtf8().constData());
        host.append_child("mLightWhite").text().set(pHost->mColorSettings.mLightWhite.name().toUtf8().constData());
