...
{
    if (mStandaloneMapProgress) {
        mStandaloneMapProgressMaximum = maximum;
...
{
    if (mStandaloneMapProgress) {
        return mStandaloneMapProgressMaximum;
    }
    if (mpMapper) {
...
{
    return mStandaloneMapProgress || (mpMapper && mpMapper->isMapProgressVisible());
}
