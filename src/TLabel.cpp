...
void TLabel::setScript( Host * pHost, QString & func, const TEvent & args )
{
    mpHost = pHost;
    mScript = func;
    mpParameters = args;
...
void TLabel::setEnter( Host * pHost, QString & func, const TEvent & args )
{
    mpHost = pHost;
    mEnter = func;
    mEnterParams = args;
...
void TLabel::setLeave( Host * pHost, QString & func, const TEvent & args )
{
    mpHost = pHost;
    mLeave = func;
    mLeaveParams = args;
