...
, mMultiView(false)
{
    ...
    mpButtonPackageManagers->setText(tr("Package Manager (exp.)"));
    ...
    mpActionPackageManager->setIconText(tr("Package Manager (exp.)", "exp. stands for experimental; shortened so it doesn't make buttons huge in the main interface"));
