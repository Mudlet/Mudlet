...
private:
    ...
    static int returnWrongArgumentType(lua_State* L, const char* functionName, const QString& message, const bool useFalseInsteadofNil = false);
    static int returnWrongArgumentType(lua_State* L, const char* functionName, const char* message, const bool useFalseInsteadofNil = false);
