...
private:
    ...
    static void returnWrongArgumentType(lua_State* L, const char* functionName, const QString& message, const bool useFalseInsteadofNil = false);
    static void returnWrongArgumentType(lua_State* L, const char* functionName, const char* message, const bool useFalseInsteadofNil = false);
