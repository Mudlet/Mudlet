...
public:
    ...
    int startTempKey(const QPair<Qt::KeyboardModifiers, Qt::KeyboardModifiers>& modifiers, const int&, const QString&);
    ...
    std::pair<int, QString> startPermKey(QString&, QString&, const int&, const QPair<Qt::KeyboardModifiers, Qt::KeyboardModifiers>& modifiers, QString&);
