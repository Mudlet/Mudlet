...
void TLuaInterpreter::initLuaGlobals()
{
    ...
    lua_register(pGlobalLua, "getWindowWrapIndent", TLuaInterpreter::getWindowWrapIndent);
    lua_register(pGlobalLua, "getWindowWrapHangingIndent", TLuaInterpreter::getWindowWrapHangingIndent);
