...
void TLuaInterpreter::initLuaGlobals()
{
    ...
    lua_register(pGlobalLua, "createCanvas", TLuaInterpreter::createCanvas);
    lua_register(pGlobalLua, "deleteCanvas", TLuaInterpreter::deleteCanvas);
    lua_register(pGlobalLua, "canvasDrawLine", TLuaInterpreter::canvasDrawLine);
    lua_register(pGlobalLua, "canvasDrawRect", TLuaInterpreter::canvasDrawRect);
    lua_register(pGlobalLua, "canvasDrawEllipse", TLuaInterpreter::canvasDrawEllipse);
    lua_register(pGlobalLua, "canvasClear", TLuaInterpreter::canvasClear);
    lua_register(pGlobalLua, "canvasSetClickThrough", TLuaInterpreter::canvasSetClickThrough);
    lua_register(pGlobalLua, "moveCanvas", TLuaInterpreter::moveCanvas);
    lua_register(pGlobalLua, "resizeCanvas", TLuaInterpreter::resizeCanvas);
    lua_register(pGlobalLua, "showCanvas", TLuaInterpreter::showCanvas);
    lua_register(pGlobalLua, "hideCanvas", TLuaInterpreter::hideCanvas);
    lua_register(pGlobalLua, "raiseCanvas", TLuaInterpreter::raiseCanvas);
    lua_register(pGlobalLua, "lowerCanvas", TLuaInterpreter::lowerCanvas);
