...
void TLuaInterpreter::initLuaGlobals()
{
    ...
    lua_pushstring( pGlobalLua, QStringLiteral( "SESSION" ).toUtf8() );
    lua_pushnumber( pGlobalLua, mHostID );
    lua_settable( pGlobalLua, LUA_GLOBALSINDEX );

    lua_pushstring( pGlobalLua, QStringLiteral( "SCRIPT_NAME" ).toUtf8() );
    lua_pushstring( pGlobalLua, QStringLiteral( "Global Lua Session Interpreter" ).toUtf8() );
    lua_settable( pGlobalLua, LUA_GLOBALSINDEX );

    lua_pushstring( pGlobalLua, QStringLiteral( "SCRIPT_ID" ).toUtf8() );
    lua_pushnumber( pGlobalLua, -1 ); // ID 1 is used to indicate that this is the global Lua interpreter
    lua_settable( pGlobalLua, LUA_GLOBALSINDEX );
    lua_register( pGlobalLua, QStringLiteral( "showUnzipProgress" ).toUtf8(), TLuaInterpreter::showUnzipProgress );//internal function used by the package system NOT FOR USERS
    lua_register( pGlobalLua, QStringLiteral( "wait" ).toUtf8(), TLuaInterpreter::Wait );
    lua_register( pGlobalLua, QStringLiteral( "expandAlias" ).toUtf8(), TLuaInterpreter::Send );
    lua_register( pGlobalLua, QStringLiteral( "echo" ).toUtf8(), TLuaInterpreter::Echo );
    lua_register( pGlobalLua, QStringLiteral( "selectString" ).toUtf8(), TLuaInterpreter::select );
    lua_register( pGlobalLua, QStringLiteral( "selectSection" ).toUtf8(), TLuaInterpreter::selectSection );
    lua_register( pGlobalLua, QStringLiteral( "replace" ).toUtf8(), TLuaInterpreter::replace );
    lua_register( pGlobalLua, QStringLiteral( "setBgColor" ).toUtf8(), TLuaInterpreter::setBgColor );
    lua_register( pGlobalLua, QStringLiteral( "setFgColor" ).toUtf8(), TLuaInterpreter::setFgColor );
    lua_register( pGlobalLua, QStringLiteral( "tempTimer" ).toUtf8(), TLuaInterpreter::tempTimer );
    lua_register( pGlobalLua, QStringLiteral( "tempTrigger" ).toUtf8(), TLuaInterpreter::tempTrigger );
    lua_register( pGlobalLua, QStringLiteral( "tempRegexTrigger" ).toUtf8(), TLuaInterpreter::tempRegexTrigger );
    lua_register( pGlobalLua, QStringLiteral( "openUserWindow" ).toUtf8(), TLuaInterpreter::openUserWindow );
    lua_register( pGlobalLua, QStringLiteral( "echoUserWindow" ).toUtf8(), TLuaInterpreter::echoUserWindow );
    lua_register( pGlobalLua, QStringLiteral( "enableTimer" ).toUtf8(), TLuaInterpreter::enableTimer );
    lua_register( pGlobalLua, QStringLiteral( "disableTimer" ).toUtf8(), TLuaInterpreter::disableTimer );
    lua_register( pGlobalLua, QStringLiteral( "enableKey" ).toUtf8(), TLuaInterpreter::enableKey );
    lua_register( pGlobalLua, QStringLiteral( "disableKey" ).toUtf8(), TLuaInterpreter::disableKey );
    lua_register( pGlobalLua, QStringLiteral( "clearUserWindow" ).toUtf8(), TLuaInterpreter::clearUserWindow );
    lua_register( pGlobalLua, QStringLiteral( "clearWindow" ).toUtf8(), TLuaInterpreter::clearUserWindow );
    lua_register( pGlobalLua, QStringLiteral( "killTimer" ).toUtf8(), TLuaInterpreter::killTimer );
    lua_register( pGlobalLua, QStringLiteral( "moveCursor" ).toUtf8(), TLuaInterpreter::moveCursor );
    lua_register( pGlobalLua, QStringLiteral( "getLines" ).toUtf8(), TLuaInterpreter::getLines );
    lua_register( pGlobalLua, QStringLiteral( "getLineNumber" ).toUtf8(), TLuaInterpreter::getLineNumber );
    lua_register( pGlobalLua, QStringLiteral( "insertHTML" ).toUtf8(), TLuaInterpreter::insertHTML );
    lua_register( pGlobalLua, QStringLiteral( "insertText" ).toUtf8(), TLuaInterpreter::insertText );
    lua_register( pGlobalLua, QStringLiteral( "enableTrigger" ).toUtf8(), TLuaInterpreter::enableTrigger );
    lua_register( pGlobalLua, QStringLiteral( "disableTrigger" ).toUtf8(), TLuaInterpreter::disableTrigger );
    lua_register( pGlobalLua, QStringLiteral( "killTrigger" ).toUtf8(), TLuaInterpreter::killTrigger );
    lua_register( pGlobalLua, QStringLiteral( "getLineCount" ).toUtf8(), TLuaInterpreter::getLineCount );
    lua_register( pGlobalLua, QStringLiteral( "getColumnNumber" ).toUtf8(), TLuaInterpreter::getColumnNumber );
    //lua_register( pGlobalLua, QStringLiteral( "getBufferTable" ).toUtf8(), TLuaInterpreter::getBufferTable );
    //lua_register( pGlobalLua, QStringLiteral( "getBufferLine" ).toUtf8(), TLuaInterpreter::getBufferLine );
    lua_register( pGlobalLua, QStringLiteral( "send" ).toUtf8(), TLuaInterpreter::sendRaw );
    lua_register( pGlobalLua, QStringLiteral( "selectCaptureGroup" ).toUtf8(), TLuaInterpreter::selectCaptureGroup );
    lua_register( pGlobalLua, QStringLiteral( "tempLineTrigger" ).toUtf8(), TLuaInterpreter::tempLineTrigger );
    lua_register( pGlobalLua, QStringLiteral( "raiseEvent" ).toUtf8(), TLuaInterpreter::raiseEvent );
    lua_register( pGlobalLua, QStringLiteral( "deleteLine" ).toUtf8(), TLuaInterpreter::deleteLine );
    lua_register( pGlobalLua, QStringLiteral( "copy" ).toUtf8(), TLuaInterpreter::copy );
    lua_register( pGlobalLua, QStringLiteral( "cut" ).toUtf8(), TLuaInterpreter::cut );
    lua_register( pGlobalLua, QStringLiteral( "paste" ).toUtf8(), TLuaInterpreter::paste );
    lua_register( pGlobalLua, QStringLiteral( "pasteWindow" ).toUtf8(), TLuaInterpreter::pasteWindow );
    //lua_register( pGlobalLua, QStringLiteral( "userWindowLineWrap" ).toUtf8(), TLuaInterpreter::userWindowLineWrap );
    lua_register( pGlobalLua, QStringLiteral( "debugc" ).toUtf8(), TLuaInterpreter::debug );
    lua_register( pGlobalLua, QStringLiteral( "setWindowWrap" ).toUtf8(), TLuaInterpreter::setWindowWrap );
    lua_register( pGlobalLua, QStringLiteral( "setWindowWrapIndent" ).toUtf8(), TLuaInterpreter::setWindowWrapIndent );
    lua_register( pGlobalLua, QStringLiteral( "resetFormat" ).toUtf8(), TLuaInterpreter::reset );
    lua_register( pGlobalLua, QStringLiteral( "moveCursorEnd" ).toUtf8(), TLuaInterpreter::moveCursorEnd );
    lua_register( pGlobalLua, QStringLiteral( "getLastLineNumber" ).toUtf8(), TLuaInterpreter::getLastLineNumber );
    lua_register( pGlobalLua, QStringLiteral( "getNetworkLatency" ).toUtf8(), TLuaInterpreter::getNetworkLatency );
    lua_register( pGlobalLua, QStringLiteral( "createMiniConsole" ).toUtf8(), TLuaInterpreter::createMiniConsole );
    lua_register( pGlobalLua, QStringLiteral( "createLabel" ).toUtf8(), TLuaInterpreter::createLabel );
    lua_register( pGlobalLua, QStringLiteral( "hideWindow" ).toUtf8(), TLuaInterpreter::hideUserWindow );
    lua_register( pGlobalLua, QStringLiteral( "showWindow" ).toUtf8(), TLuaInterpreter::showUserWindow );
    lua_register( pGlobalLua, QStringLiteral( "createBuffer" ).toUtf8(), TLuaInterpreter::createBuffer );
    lua_register( pGlobalLua, QStringLiteral( "createStopWatch" ).toUtf8(), TLuaInterpreter::createStopWatch );
    lua_register( pGlobalLua, QStringLiteral( "getStopWatchTime" ).toUtf8(), TLuaInterpreter::getStopWatchTime );
    lua_register( pGlobalLua, QStringLiteral( "stopStopWatch" ).toUtf8(), TLuaInterpreter::stopStopWatch );
    lua_register( pGlobalLua, QStringLiteral( "startStopWatch" ).toUtf8(), TLuaInterpreter::startStopWatch );
    lua_register( pGlobalLua, QStringLiteral( "resetStopWatch" ).toUtf8(), TLuaInterpreter::resetStopWatch );
    lua_register( pGlobalLua, QStringLiteral( "closeUserWindow" ).toUtf8(), TLuaInterpreter::closeUserWindow );
    lua_register( pGlobalLua, QStringLiteral( "resizeWindow" ).toUtf8(), TLuaInterpreter::resizeUserWindow );
    lua_register( pGlobalLua, QStringLiteral( "appendBuffer" ).toUtf8(), TLuaInterpreter::appendBuffer );
    lua_register( pGlobalLua, QStringLiteral( "setBackgroundImage" ).toUtf8(), TLuaInterpreter::setBackgroundImage );
    lua_register( pGlobalLua, QStringLiteral( "setBackgroundColor" ).toUtf8(), TLuaInterpreter::setBackgroundColor );
    lua_register( pGlobalLua, QStringLiteral( "createButton" ).toUtf8(), TLuaInterpreter::createButton );
    lua_register( pGlobalLua, QStringLiteral( "setLabelClickCallback" ).toUtf8(), TLuaInterpreter::setLabelClickCallback );
    lua_register( pGlobalLua, QStringLiteral( "setLabelOnEnter" ).toUtf8(), TLuaInterpreter::setLabelOnEnter );
    lua_register( pGlobalLua, QStringLiteral( "setLabelOnLeave" ).toUtf8(), TLuaInterpreter::setLabelOnLeave );
    lua_register( pGlobalLua, QStringLiteral( "moveWindow" ).toUtf8(), TLuaInterpreter::moveWindow );
    lua_register( pGlobalLua, QStringLiteral( "setTextFormat" ).toUtf8(), TLuaInterpreter::setTextFormat );
    lua_register( pGlobalLua, QStringLiteral( "getMainWindowSize" ).toUtf8(), TLuaInterpreter::getMainWindowSize );
    lua_register( pGlobalLua, QStringLiteral( "getCurrentLine" ).toUtf8(), TLuaInterpreter::getCurrentLine );
    lua_register( pGlobalLua, QStringLiteral( "setMiniConsoleFontSize" ).toUtf8(), TLuaInterpreter::setMiniConsoleFontSize );
    lua_register( pGlobalLua, QStringLiteral( "selectCurrentLine" ).toUtf8(), TLuaInterpreter::selectCurrentLine );
    lua_register( pGlobalLua, QStringLiteral( "spawn" ).toUtf8(), TLuaInterpreter::spawn );
    lua_register( pGlobalLua, QStringLiteral( "getButtonState" ).toUtf8(), TLuaInterpreter::getButtonState );
    lua_register( pGlobalLua, QStringLiteral( "showToolBar" ).toUtf8(), TLuaInterpreter::showToolBar );
    lua_register( pGlobalLua, QStringLiteral( "hideToolBar" ).toUtf8(), TLuaInterpreter::hideToolBar );
    lua_register( pGlobalLua, QStringLiteral( "loadRawFile" ).toUtf8(), TLuaInterpreter::loadRawFile );
    lua_register( pGlobalLua, QStringLiteral( "setBold" ).toUtf8(), TLuaInterpreter::setBold );
    lua_register( pGlobalLua, QStringLiteral( "setItalics" ).toUtf8(), TLuaInterpreter::setItalics );
    lua_register( pGlobalLua, QStringLiteral( "setUnderline" ).toUtf8(), TLuaInterpreter::setUnderline );
    lua_register( pGlobalLua, QStringLiteral( "disconnect" ).toUtf8(), TLuaInterpreter::disconnect );
    lua_register( pGlobalLua, QStringLiteral( "tempButtonToolbar" ).toUtf8(), TLuaInterpreter::tempButtonToolbar );
    lua_register( pGlobalLua, QStringLiteral( "tempButton" ).toUtf8(), TLuaInterpreter::tempButton );
    lua_register( pGlobalLua, QStringLiteral( "reconnect" ).toUtf8(), TLuaInterpreter::reconnect );
    lua_register( pGlobalLua, QStringLiteral( "getMudletHomeDir" ).toUtf8(), TLuaInterpreter::getMudletHomeDir );
    lua_register( pGlobalLua, QStringLiteral( "setTriggerStayOpen" ).toUtf8(), TLuaInterpreter::setTriggerStayOpen );
    lua_register( pGlobalLua, QStringLiteral( "wrapLine" ).toUtf8(), TLuaInterpreter::wrapLine );
    lua_register( pGlobalLua, QStringLiteral( "getFgColor" ).toUtf8(), TLuaInterpreter::getFgColor );
    lua_register( pGlobalLua, QStringLiteral( "getBgColor" ).toUtf8(), TLuaInterpreter::getBgColor );
    lua_register( pGlobalLua, QStringLiteral( "tempColorTrigger" ).toUtf8(), TLuaInterpreter::tempColorTrigger );
    lua_register( pGlobalLua, QStringLiteral( "isAnsiFgColor" ).toUtf8(), TLuaInterpreter::isAnsiFgColor );
    lua_register( pGlobalLua, QStringLiteral( "isAnsiBgColor" ).toUtf8(), TLuaInterpreter::isAnsiBgColor );
    lua_register( pGlobalLua, QStringLiteral( "stopSounds" ).toUtf8(), TLuaInterpreter::stopSounds );
    lua_register( pGlobalLua, QStringLiteral( "playSoundFile" ).toUtf8(), TLuaInterpreter::playSoundFile );
    lua_register( pGlobalLua, QStringLiteral( "setBorderTop" ).toUtf8(), TLuaInterpreter::setBorderTop );
    lua_register( pGlobalLua, QStringLiteral( "setBorderBottom" ).toUtf8(), TLuaInterpreter::setBorderBottom );
    lua_register( pGlobalLua, QStringLiteral( "setBorderLeft" ).toUtf8(), TLuaInterpreter::setBorderLeft );
    lua_register( pGlobalLua, QStringLiteral( "setBorderRight" ).toUtf8(), TLuaInterpreter::setBorderRight );
    lua_register( pGlobalLua, QStringLiteral( "setBorderColor" ).toUtf8(), TLuaInterpreter::setBorderColor );
    lua_register( pGlobalLua, QStringLiteral( "setConsoleBufferSize" ).toUtf8(), TLuaInterpreter::setConsoleBufferSize );
    lua_register( pGlobalLua, QStringLiteral( "startLogging" ).toUtf8(), TLuaInterpreter::startLogging );
    lua_register( pGlobalLua, QStringLiteral( "calcFontSize" ).toUtf8(), TLuaInterpreter::calcFontSize );
    lua_register( pGlobalLua, QStringLiteral( "permRegexTrigger" ).toUtf8(), TLuaInterpreter::permRegexTrigger );
    lua_register( pGlobalLua, QStringLiteral( "permSubstringTrigger" ).toUtf8(), TLuaInterpreter::permSubstringTrigger );
    lua_register( pGlobalLua, QStringLiteral( "permBeginOfLineStringTrigger" ).toUtf8(), TLuaInterpreter::permBeginOfLineStringTrigger );
    lua_register( pGlobalLua, QStringLiteral( "tempComplexRegexTrigger" ).toUtf8(), TLuaInterpreter::tempComplexRegexTrigger );
    lua_register( pGlobalLua, QStringLiteral( "permTimer" ).toUtf8(), TLuaInterpreter::permTimer );
    lua_register( pGlobalLua, QStringLiteral( "permAlias" ).toUtf8(), TLuaInterpreter::permAlias );
    lua_register( pGlobalLua, QStringLiteral( "exists" ).toUtf8(), TLuaInterpreter::exists );
    lua_register( pGlobalLua, QStringLiteral( "isActive" ).toUtf8(), TLuaInterpreter::isActive );
    lua_register( pGlobalLua, QStringLiteral( "enableAlias" ).toUtf8(), TLuaInterpreter::enableAlias );
    lua_register( pGlobalLua, QStringLiteral( "tempAlias" ).toUtf8(), TLuaInterpreter::tempAlias );
    lua_register( pGlobalLua, QStringLiteral( "disableAlias" ).toUtf8(), TLuaInterpreter::disableAlias );
    lua_register( pGlobalLua, QStringLiteral( "killAlias" ).toUtf8(), TLuaInterpreter::killAlias );
    lua_register( pGlobalLua, QStringLiteral( "setLabelStyleSheet" ).toUtf8(), TLuaInterpreter::setLabelStyleSheet );
    lua_register( pGlobalLua, QStringLiteral( "getTime" ).toUtf8(), TLuaInterpreter::getTime );
    lua_register( pGlobalLua, QStringLiteral( "invokeFileDialog" ).toUtf8(), TLuaInterpreter::invokeFileDialog );
    lua_register( pGlobalLua, QStringLiteral( "getTimestamp" ).toUtf8(), TLuaInterpreter::getTimestamp );
    lua_register( pGlobalLua, QStringLiteral( "setLink" ).toUtf8(), TLuaInterpreter::setLink );
    lua_register( pGlobalLua, QStringLiteral( "deselect" ).toUtf8(), TLuaInterpreter::deselect );
    lua_register( pGlobalLua, QStringLiteral( "insertLink" ).toUtf8(), TLuaInterpreter::insertLink );
    lua_register( pGlobalLua, QStringLiteral( "echoLink" ).toUtf8(), TLuaInterpreter::echoLink );
    lua_register( pGlobalLua, QStringLiteral( "echoPopup" ).toUtf8(), TLuaInterpreter::echoPopup );
    lua_register( pGlobalLua, QStringLiteral( "insertPopup" ).toUtf8(), TLuaInterpreter::insertPopup );
    lua_register( pGlobalLua, QStringLiteral( "setPopup" ).toUtf8(), TLuaInterpreter::setPopup );
    lua_register( pGlobalLua, QStringLiteral( "sendATCP" ).toUtf8(), TLuaInterpreter::sendATCP );
    lua_register( pGlobalLua, QStringLiteral( "hasFocus" ).toUtf8(), TLuaInterpreter::hasFocus );
    lua_register( pGlobalLua, QStringLiteral( "isPrompt" ).toUtf8(), TLuaInterpreter::isPrompt );
    lua_register( pGlobalLua, QStringLiteral( "feedTriggers" ).toUtf8(), TLuaInterpreter::feedTriggers );
    lua_register( pGlobalLua, QStringLiteral( "sendTelnetChannel102" ).toUtf8(), TLuaInterpreter::sendTelnetChannel102 );
    lua_register( pGlobalLua, QStringLiteral( "setRoomWeight" ).toUtf8(), TLuaInterpreter::setRoomWeight );
    lua_register( pGlobalLua, QStringLiteral( "getRoomWeight" ).toUtf8(), TLuaInterpreter::getRoomWeight );
    lua_register( pGlobalLua, QStringLiteral( "gotoRoom" ).toUtf8(), TLuaInterpreter::gotoRoom );
    lua_register( pGlobalLua, QStringLiteral( "setMapperView" ).toUtf8(), TLuaInterpreter::setMapperView );
    lua_register( pGlobalLua, QStringLiteral( "getRoomExits" ).toUtf8(), TLuaInterpreter::getRoomExits );
    lua_register( pGlobalLua, QStringLiteral( "lockRoom" ).toUtf8(), TLuaInterpreter::lockRoom );
    lua_register( pGlobalLua, QStringLiteral( "createMapper" ).toUtf8(), TLuaInterpreter::createMapper );
    lua_register( pGlobalLua, QStringLiteral( "getMainConsoleWidth" ).toUtf8(), TLuaInterpreter::getMainConsoleWidth );
    lua_register( pGlobalLua, QStringLiteral( "resetProfile" ).toUtf8(), TLuaInterpreter::resetProfile );
    lua_register( pGlobalLua, QStringLiteral( "printCmdLine" ).toUtf8(), TLuaInterpreter::printCmdLine );
    lua_register( pGlobalLua, QStringLiteral( "searchRoom" ).toUtf8(), TLuaInterpreter::searchRoom );
    lua_register( pGlobalLua, QStringLiteral( "clearCmdLine" ).toUtf8(), TLuaInterpreter::clearCmdLine );
    lua_register( pGlobalLua, QStringLiteral( "getAreaTable" ).toUtf8(), TLuaInterpreter::getAreaTable );
    lua_register( pGlobalLua, QStringLiteral( "getAreaTableSwap" ).toUtf8(), TLuaInterpreter::getAreaTableSwap );
    lua_register( pGlobalLua, QStringLiteral( "getAreaRooms" ).toUtf8(), TLuaInterpreter::getAreaRooms );
    lua_register( pGlobalLua, QStringLiteral( "getPath" ).toUtf8(), TLuaInterpreter::getPath );
    lua_register( pGlobalLua, QStringLiteral( "centerview" ).toUtf8(), TLuaInterpreter::centerview );
    lua_register( pGlobalLua, QStringLiteral( "denyCurrentSend" ).toUtf8(), TLuaInterpreter::denyCurrentSend );
    lua_register( pGlobalLua, QStringLiteral( "tempBeginOfLineTrigger" ).toUtf8(), TLuaInterpreter::tempBeginOfLineTrigger );
    lua_register( pGlobalLua, QStringLiteral( "tempExactMatchTrigger" ).toUtf8(), TLuaInterpreter::tempExactMatchTrigger );
    lua_register( pGlobalLua, QStringLiteral( "sendGMCP" ).toUtf8(), TLuaInterpreter::sendGMCP );
    lua_register( pGlobalLua, QStringLiteral( "roomExists" ).toUtf8(), TLuaInterpreter::roomExists );
    lua_register( pGlobalLua, QStringLiteral( "addRoom" ).toUtf8(), TLuaInterpreter::addRoom );
    lua_register( pGlobalLua, QStringLiteral( "setExit" ).toUtf8(), TLuaInterpreter::setExit );
    lua_register( pGlobalLua, QStringLiteral( "setRoomCoordinates" ).toUtf8(), TLuaInterpreter::setRoomCoordinates );
    lua_register( pGlobalLua, QStringLiteral( "getRoomCoordinates" ).toUtf8(), TLuaInterpreter::getRoomCoordinates );
    lua_register( pGlobalLua, QStringLiteral( "createRoomID" ).toUtf8(), TLuaInterpreter::createRoomID );
    lua_register( pGlobalLua, QStringLiteral( "getRoomArea" ).toUtf8(), TLuaInterpreter::getRoomArea );
    lua_register( pGlobalLua, QStringLiteral( "setRoomArea" ).toUtf8(), TLuaInterpreter::setRoomArea );
    lua_register( pGlobalLua, QStringLiteral( "resetRoomArea" ).toUtf8(), TLuaInterpreter::resetRoomArea );
    lua_register( pGlobalLua, QStringLiteral( "setAreaName" ).toUtf8(), TLuaInterpreter::setAreaName );
    lua_register( pGlobalLua, QStringLiteral( "roomLocked" ).toUtf8(), TLuaInterpreter::roomLocked );
    lua_register( pGlobalLua, QStringLiteral( "setCustomEnvColor" ).toUtf8(), TLuaInterpreter::setCustomEnvColor );
    lua_register( pGlobalLua, QStringLiteral( "getCustomEnvColorTable" ).toUtf8(), TLuaInterpreter::getCustomEnvColorTable );
    //lua_register( pGlobalLua, QStringLiteral( "setLevelColor" ).toUtf8(), TLuaInterpreter::setLevelColor );
    //lua_register( pGlobalLua, QStringLiteral( "getLevelColorTable" ).toUtf8(), TLuaInterpreter::getLevelColorTable );
    lua_register( pGlobalLua, QStringLiteral( "setRoomEnv" ).toUtf8(), TLuaInterpreter::setRoomEnv );
    lua_register( pGlobalLua, QStringLiteral( "setRoomName" ).toUtf8(), TLuaInterpreter::setRoomName );
    lua_register( pGlobalLua, QStringLiteral( "getRoomName" ).toUtf8(), TLuaInterpreter::getRoomName );
    lua_register( pGlobalLua, QStringLiteral( "setGridMode" ).toUtf8(), TLuaInterpreter::setGridMode );
    lua_register( pGlobalLua, QStringLiteral( "solveRoomCollisions" ).toUtf8(), TLuaInterpreter::solveRoomCollisions );
    lua_register( pGlobalLua, QStringLiteral( "addSpecialExit" ).toUtf8(), TLuaInterpreter::addSpecialExit );
    lua_register( pGlobalLua, QStringLiteral( "removeSpecialExit" ).toUtf8(), TLuaInterpreter::removeSpecialExit );
    lua_register( pGlobalLua, QStringLiteral( "getSpecialExits" ).toUtf8(), TLuaInterpreter::getSpecialExits );
    lua_register( pGlobalLua, QStringLiteral( "getSpecialExitsSwap" ).toUtf8(), TLuaInterpreter::getSpecialExitsSwap );
    lua_register( pGlobalLua, QStringLiteral( "clearSpecialExits" ).toUtf8(), TLuaInterpreter::clearSpecialExits );
    lua_register( pGlobalLua, QStringLiteral( "getRoomEnv" ).toUtf8(), TLuaInterpreter::getRoomEnv );
    lua_register( pGlobalLua, QStringLiteral( "getRoomUserData" ).toUtf8(), TLuaInterpreter::getRoomUserData );
    lua_register( pGlobalLua, QStringLiteral( "setRoomUserData" ).toUtf8(), TLuaInterpreter::setRoomUserData );
    lua_register( pGlobalLua, QStringLiteral( "searchRoomUserData" ).toUtf8(), TLuaInterpreter::searchRoomUserData );
    lua_register( pGlobalLua, QStringLiteral( "getRoomsByPosition" ).toUtf8(), TLuaInterpreter::getRoomsByPosition );
    //lua_register( pGlobalLua, QStringLiteral( "dumpRoomUserData" ).toUtf8(), TLuaInterpreter::dumpRoomUserData );
    lua_register( pGlobalLua, QStringLiteral( "clearRoomUserData" ).toUtf8(), TLuaInterpreter::clearRoomUserData );
    lua_register( pGlobalLua, QStringLiteral( "downloadFile" ).toUtf8(), TLuaInterpreter::downloadFile );
    lua_register( pGlobalLua, QStringLiteral( "appendCmdLine" ).toUtf8(), TLuaInterpreter::appendCmdLine );
    lua_register( pGlobalLua, QStringLiteral( "openUrl" ).toUtf8(), TLuaInterpreter::openUrl );
    lua_register( pGlobalLua, QStringLiteral( "sendSocket" ).toUtf8(), TLuaInterpreter::sendSocket );
    lua_register( pGlobalLua, QStringLiteral( "setRoomIDbyHash" ).toUtf8(), TLuaInterpreter::setRoomIDbyHash );
    lua_register( pGlobalLua, QStringLiteral( "getRoomIDbyHash" ).toUtf8(), TLuaInterpreter::getRoomIDbyHash );
    lua_register( pGlobalLua, QStringLiteral( "addAreaName" ).toUtf8(), TLuaInterpreter::addAreaName );
    lua_register( pGlobalLua, QStringLiteral( "getRoomAreaName" ).toUtf8(), TLuaInterpreter::getRoomAreaName );
    lua_register( pGlobalLua, QStringLiteral( "deleteArea" ).toUtf8(), TLuaInterpreter::deleteArea );
    lua_register( pGlobalLua, QStringLiteral( "deleteRoom" ).toUtf8(), TLuaInterpreter::deleteRoom );
    lua_register( pGlobalLua, QStringLiteral( "setRoomChar" ).toUtf8(), TLuaInterpreter::setRoomChar );
    lua_register( pGlobalLua, QStringLiteral( "getRoomChar" ).toUtf8(), TLuaInterpreter::getRoomChar );
    lua_register( pGlobalLua, QStringLiteral( "registerAnonymousEventHandler" ).toUtf8(), TLuaInterpreter::registerAnonymousEventHandler );
    lua_register( pGlobalLua, QStringLiteral( "saveMap" ).toUtf8(), TLuaInterpreter::saveMap );
    lua_register( pGlobalLua, QStringLiteral( "loadMap" ).toUtf8(), TLuaInterpreter::loadMap );
    lua_register( pGlobalLua, QStringLiteral( "setMainWindowSize" ).toUtf8(), TLuaInterpreter::setMainWindowSize );
    lua_register( pGlobalLua, QStringLiteral( "setAppStyleSheet" ).toUtf8(), TLuaInterpreter::setAppStyleSheet );
    lua_register( pGlobalLua, QStringLiteral( "sendIrc" ).toUtf8(), TLuaInterpreter::sendIrc );
    lua_register( pGlobalLua, QStringLiteral( "connectToServer" ).toUtf8(), TLuaInterpreter::connectToServer );
    lua_register( pGlobalLua, QStringLiteral( "getRooms" ).toUtf8(), TLuaInterpreter::getRooms );
    lua_register( pGlobalLua, QStringLiteral( "createMapLabel" ).toUtf8(), TLuaInterpreter::createMapLabel );
    lua_register( pGlobalLua, QStringLiteral( "deleteMapLabel" ).toUtf8(), TLuaInterpreter::deleteMapLabel );
    lua_register( pGlobalLua, QStringLiteral( "highlightRoom" ).toUtf8(), TLuaInterpreter::highlightRoom );
    lua_register( pGlobalLua, QStringLiteral( "unHighlightRoom" ).toUtf8(), TLuaInterpreter::unHighlightRoom );
    lua_register( pGlobalLua, QStringLiteral( "getMapLabels" ).toUtf8(), TLuaInterpreter::getMapLabels );
    lua_register( pGlobalLua, QStringLiteral( "getMapLabel" ).toUtf8(), TLuaInterpreter::getMapLabel );
    lua_register( pGlobalLua, QStringLiteral( "lockExit" ).toUtf8(), TLuaInterpreter::lockExit );
    lua_register( pGlobalLua, QStringLiteral( "hasExitLock" ).toUtf8(), TLuaInterpreter::hasExitLock );
    lua_register( pGlobalLua, QStringLiteral( "lockSpecialExit" ).toUtf8(), TLuaInterpreter::lockSpecialExit );
    lua_register( pGlobalLua, QStringLiteral( "hasSpecialExitLock" ).toUtf8(), TLuaInterpreter::hasSpecialExitLock );
    lua_register( pGlobalLua, QStringLiteral( "setExitStub" ).toUtf8(), TLuaInterpreter::setExitStub );
    lua_register( pGlobalLua, QStringLiteral( "connectExitStub" ).toUtf8(), TLuaInterpreter::connectExitStub );
    lua_register( pGlobalLua, QStringLiteral( "getExitStubs" ).toUtf8(), TLuaInterpreter::getExitStubs );
    lua_register( pGlobalLua, QStringLiteral( "getExitStubs1" ).toUtf8(), TLuaInterpreter::getExitStubs1 );
    lua_register( pGlobalLua, QStringLiteral( "setModulePriority" ).toUtf8(), TLuaInterpreter::setModulePriority );
    lua_register( pGlobalLua, QStringLiteral( "getModulePriority" ).toUtf8(), TLuaInterpreter::getModulePriority );
    lua_register( pGlobalLua, QStringLiteral( "updateMap" ).toUtf8(), TLuaInterpreter::updateMap );
    lua_register( pGlobalLua, QStringLiteral( "addMapEvent" ).toUtf8(), TLuaInterpreter::addMapEvent );
    lua_register( pGlobalLua, QStringLiteral( "removeMapEvent" ).toUtf8(), TLuaInterpreter::removeMapEvent );
    lua_register( pGlobalLua, QStringLiteral( "getMapEvents" ).toUtf8(), TLuaInterpreter::getMapEvents );
    lua_register( pGlobalLua, QStringLiteral( "addMapMenu" ).toUtf8(), TLuaInterpreter::addMapMenu );
    lua_register( pGlobalLua, QStringLiteral( "removeMapMenu" ).toUtf8(), TLuaInterpreter::removeMapMenu );
    lua_register( pGlobalLua, QStringLiteral( "getMapMenus" ).toUtf8(), TLuaInterpreter::getMapMenus );
    lua_register( pGlobalLua, QStringLiteral( "installPackage" ).toUtf8(), TLuaInterpreter::installPackage );
    lua_register( pGlobalLua, QStringLiteral( "installModule" ).toUtf8(), TLuaInterpreter::installModule );
    lua_register( pGlobalLua, QStringLiteral( "uninstallModule" ).toUtf8(), TLuaInterpreter::uninstallModule );
    lua_register( pGlobalLua, QStringLiteral( "reloadModule" ).toUtf8(), TLuaInterpreter::reloadModule );
    lua_register( pGlobalLua, QStringLiteral( "exportAreaImage" ).toUtf8(), TLuaInterpreter::exportAreaImage );
    lua_register( pGlobalLua, QStringLiteral( "createMapImageLabel" ).toUtf8(), TLuaInterpreter::createMapImageLabel );
    lua_register( pGlobalLua, QStringLiteral( "setMapZoom" ).toUtf8(), TLuaInterpreter::setMapZoom );
    lua_register( pGlobalLua, QStringLiteral( "uninstallPackage" ).toUtf8(), TLuaInterpreter::uninstallPackage );
    lua_register( pGlobalLua, QStringLiteral( "setExitWeight" ).toUtf8(), TLuaInterpreter::setExitWeight );
    lua_register( pGlobalLua, QStringLiteral( "setDoor" ).toUtf8(), TLuaInterpreter::setDoor );
    lua_register( pGlobalLua, QStringLiteral( "getDoors" ).toUtf8(), TLuaInterpreter::getDoors );
    lua_register( pGlobalLua, QStringLiteral( "getExitWeights" ).toUtf8(), TLuaInterpreter::getExitWeights );
    lua_register( pGlobalLua, QStringLiteral( "addSupportedTelnetOption" ).toUtf8(), TLuaInterpreter::addSupportedTelnetOption );
    lua_register( pGlobalLua, QStringLiteral( "setMergeTables" ).toUtf8(), TLuaInterpreter::setMergeTables );
    lua_register( pGlobalLua, QStringLiteral( "getModulePath" ).toUtf8(), TLuaInterpreter::getModulePath );
    lua_register( pGlobalLua, QStringLiteral( "getAreaExits" ).toUtf8(), TLuaInterpreter::getAreaExits );
    lua_register( pGlobalLua, QStringLiteral( "auditAreas" ).toUtf8(), TLuaInterpreter::auditAreas );
    lua_register( pGlobalLua, QStringLiteral( "sendMSDP" ).toUtf8(), TLuaInterpreter::sendMSDP );
    lua_register( pGlobalLua, QStringLiteral( "handleWindowResizeEvent" ).toUtf8(), TLuaInterpreter::noop );
    lua_register( pGlobalLua, QStringLiteral( "addCustomLine" ).toUtf8(), TLuaInterpreter::addCustomLine );
    lua_register( pGlobalLua, QStringLiteral( "getCustomLines" ).toUtf8(), TLuaInterpreter::getCustomLines );
    lua_register( pGlobalLua, QStringLiteral( "getMudletVersion" ).toUtf8(), TLuaInterpreter::getMudletVersion );



    luaopen_yajl(pGlobalLua);
    lua_setglobal( pGlobalLua, QStringLiteral( "yajl" ).toUtf8() );

#ifdef Q_OS_MAC
    luaopen_zip( pGlobalLua );
    lua_setglobal( pGlobalLua, QStringLiteral( "zip" ).toUtf8() );
#endif
    QString n;
    int error;
    ...
    // CHECKME: This doesn't mean much on Windows, I dunno whether it applies to Macs - SlySven
    luaL_dostring (pGlobalLua, QStringLiteral( "if jit then package.cpath = package.cpath .. ';/usr/lib/lua/5.1/?.so;/usr/lib/x86_64-linux-gnu/lua/5.1/?.so' end" ).toUtf8() );
#endif

    QString msg;
    error = luaL_dostring( pGlobalLua, QStringLiteral( "require \"rex_pcre\"" ).toUtf8() );
    if( error )
    {
        if( lua_isstring( pGlobalLua, -1 ) )
            msg = tr( "[ ERROR ] - Cannot find Lua module rex_pcre.\n"
    ...
    error = luaL_dostring( pGlobalLua, QStringLiteral( "require \"zip\"" ).toUtf8() );
    if( error )
    {
        if( lua_isstring( pGlobalLua, -1 ) )
    ...
    error = luaL_dostring( pGlobalLua, QStringLiteral( "require \"lfs\"" ).toUtf8() );
    if( error )
    {
        if( lua_isstring( pGlobalLua, -1 ) )
    ...
    error = luaL_dostring( pGlobalLua, QStringLiteral( "luasql = require \"luasql.sqlite3\"" ).toUtf8() );
    if( error != 0 )
    {
        if( lua_isstring( pGlobalLua, -1 ) )
