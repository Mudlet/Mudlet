...
void TLuaInterpreter::initLuaGlobals()
{
    ...
    lua_register(pGlobalLua, "getKeyModifiers", TLuaInterpreter::getKeyModifiers);
    lua_register(pGlobalLua, "setKeyModifiers", TLuaInterpreter::setKeyModifiers);
...
// No documentation available in wiki - internal function
std::pair<int, QString> TLuaInterpreter::startPermKey(QString& name, QString& parent, const int& keycode, const QPair<Qt::KeyboardModifiers, Qt::KeyboardModifiers>& modifiers, QString& function)
{
    TKey* pT;
...
// No documentation available in wiki - internal function
int TLuaInterpreter::startTempKey(const QPair<Qt::KeyboardModifiers, Qt::KeyboardModifiers>& modifiers, const int& keycode, const QString& function)
{
    TKey* pT;
