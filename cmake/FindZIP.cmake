...
if(ZIP_FOUND AND NOT TARGET ZIP::ZIP)
  if(ZIP_STATIC EQUAL -1)
    ...
    if(ZIP_LIBRARY_RELEASE)
      set_property(TARGET ZIP::ZIP PROPERTY IMPORTED_IMPLIB_RELEASE "${ZIP_LIBRARY_RELEASE}")
      set_property(TARGET ZIP::ZIP PROPERTY IMPORTED_IMPLIB "${ZIP_LIBRARY_RELEASE}")
    endif()
    if(ZIP_LIBRARY_DEBUG)
      set_property(TARGET ZIP::ZIP PROPERTY IMPORTED_IMPLIB_DEBUG "${ZIP_LIBRARY_DEBUG}")
      if(NOT ZIP_LIBRARY_RELEASE)
        set_property(TARGET ZIP::ZIP PROPERTY IMPORTED_IMPLIB "${ZIP_LIBRARY_DEBUG}")
      endif()
    endif()
    if(NOT ZIP_LIBRARY_RELEASE AND NOT ZIP_LIBRARY_DEBUG AND ZIP_LIBRARY)
      set_property(TARGET ZIP::ZIP PROPERTY IMPORTED_IMPLIB "${ZIP_LIBRARY}")
    endif()
