...
IF(HUNSPELL_LIBRARY_DEBUG AND HUNSPELL_LIBRARY_RELEASE)
  SET(HUNSPELL_LIBRARIES optimized ${HUNSPELL_LIBRARY_RELEASE} debug ${HUNSPELL_LIBRARY_DEBUG} )
ELSEIF(HUNSPELL_LIBRARY_RELEASE)
  SET(HUNSPELL_LIBRARIES ${HUNSPELL_LIBRARY_RELEASE} )
ELSEIF(HUNSPELL_LIBRARY_DEBUG)
  SET(HUNSPELL_LIBRARIES ${HUNSPELL_LIBRARY_DEBUG} )
ENDIF()
...
SET( HUNSPELL_LIBRARIES "${HUNSPELL_LIBRARIES}" CACHE STRING "HUNSPELL Libraries")
...
IF(HUNSPELL_FOUND AND NOT TARGET HUNSPELL::STATIC)
  ADD_LIBRARY(HUNSPELL::STATIC STATIC IMPORTED)
  SET_TARGET_PROPERTIES(HUNSPELL::STATIC PROPERTIES
...
ENDIF()
if(HUNSPELL_FOUND AND NOT TARGET HUNSPELL::SHARED)
  ADD_LIBRARY(HUNSPELL::SHARED SHARED IMPORTED)
  SET_TARGET_PROPERTIES(HUNSPELL::SHARED PROPERTIES
    IMPORTED_LOCATION
      "${HUNSPELL_LIBRARIES}"
    INTERFACE_INCLUDE_DIRECTORIES
      "${HUNSPELL_INCLUDE_DIR}"
