...
if(HUNSPELL_FOUND AND NOT TARGET HUNSPELL::HUNSPELL)
  if(HUNSPELL_STATIC EQUAL -1)
    ...
    # Set import libraries for Windows multi-config generators
    if(HUNSPELL_LIBRARY_RELEASE)
      set_property(TARGET HUNSPELL::HUNSPELL PROPERTY IMPORTED_IMPLIB_RELEASE "${HUNSPELL_LIBRARY_RELEASE}")
      set_property(TARGET HUNSPELL::HUNSPELL PROPERTY IMPORTED_IMPLIB "${HUNSPELL_LIBRARY_RELEASE}")
    endif()
    if(HUNSPELL_LIBRARY_DEBUG)
      set_property(TARGET HUNSPELL::HUNSPELL PROPERTY IMPORTED_IMPLIB_DEBUG "${HUNSPELL_LIBRARY_DEBUG}")
      if(NOT HUNSPELL_LIBRARY_RELEASE)
        set_property(TARGET HUNSPELL::HUNSPELL PROPERTY IMPORTED_IMPLIB "${HUNSPELL_LIBRARY_DEBUG}")
      endif()
    endif()
    if(NOT HUNSPELL_LIBRARY_RELEASE AND NOT HUNSPELL_LIBRARY_DEBUG AND HUNSPELL_LIBRARY)
      set_property(TARGET HUNSPELL::HUNSPELL PROPERTY IMPORTED_IMPLIB "${HUNSPELL_LIBRARY}")
    endif()
