...
if(PCRE_FOUND AND NOT TARGET PCRE::PCRE)
  if(PCRE_STATIC EQUAL -1)
    ...
    if(PCRE_LIBRARY_RELEASE)
      set_property(TARGET PCRE::PCRE PROPERTY IMPORTED_IMPLIB_RELEASE "${PCRE_LIBRARY_RELEASE}")
      set_property(TARGET PCRE::PCRE PROPERTY IMPORTED_IMPLIB "${PCRE_LIBRARY_RELEASE}")
    endif()
    if(PCRE_LIBRARY_DEBUG)
      set_property(TARGET PCRE::PCRE PROPERTY IMPORTED_IMPLIB_DEBUG "${PCRE_LIBRARY_DEBUG}")
      if(NOT PCRE_LIBRARY_RELEASE)
        set_property(TARGET PCRE::PCRE PROPERTY IMPORTED_IMPLIB "${PCRE_LIBRARY_DEBUG}")
      endif()
    endif()
    if(NOT PCRE_LIBRARY_RELEASE AND NOT PCRE_LIBRARY_DEBUG AND PCRE_LIBRARY)
      set_property(TARGET PCRE::PCRE PROPERTY IMPORTED_IMPLIB "${PCRE_LIBRARY}")
    endif()
