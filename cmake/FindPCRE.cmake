...
ELSEIF(PC_PCRE_libpcre_FOUND)
  SET(PCRE_VERSION ${PC_PCRE_libhpcre_VERSION})
ELSE()
...
IF(PCRE_FOUND AND NOT TARGET PCRE::STATIC)
  ADD_LIBRARY(PCRE::STATIC STATIC IMPORTED)
  SET_TARGET_PROPERTIES(PCRE::STATIC PROPERTIES
...
ENDIF()
if(PCRE_FOUND AND NOT TARGET PCRE::SHARED)
  ADD_LIBRARY(PCRE::SHARED SHARED IMPORTED)
  SET_TARGET_PROPERTIES(PCRE::SHARED PROPERTIES
    IMPORTED_LOCATION
      "${PCRE_LIBRARY}"
    INTERFACE_INCLUDE_DIRECTORIES
      "${PCRE_INCLUDE_DIR}"
