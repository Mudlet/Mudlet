...
private:
    ...
    {
        const QString home = utils::getMudletPath(enums::profileHomePath, mpHostname);
...
<MudletPackage version="1.001">
    ...
    QString moduleHalfPath() const { return qsl("%1/as-module/%2.xml").arg(utils::getMudletPath(enums::profileHomePath, mpHostname), mDualName); }
    QString packageHalfPath() const { return qsl("%1/as-package/%2.xml").arg(utils::getMudletPath(enums::profileHomePath, mpHostname), mDualName); }
