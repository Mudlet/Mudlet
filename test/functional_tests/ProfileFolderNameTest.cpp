...
private:
    ...
    {
        QVERIFY(QDir().mkpath(utils::getMudletPath(enums::profileHomePath, name)));
...
private slots:
    ...
    void test_copiedFolderWithParenthesesIsUsable()
    {
        ...
        QVERIFY(QDir(utils::getMudletPath(enums::profileHomePath, mCopiedName)).exists());
    }
    ...
    void test_folderWithDisallowedCharacterIsNotMangled()
    {
        ...
        QVERIFY(QDir(utils::getMudletPath(enums::profileHomePath, mForeignName)).exists());
    }
    ...
    void test_folderWithTrailingWhitespaceIsNotMangled()
    {
        ...
        QVERIFY(QDir(utils::getMudletPath(enums::profileHomePath, mPaddedName)).exists());
    }
