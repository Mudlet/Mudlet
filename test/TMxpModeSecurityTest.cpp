...
private:
  ...
  public:
    ...
    void setProcessor(TMxpProcessor *processor) { mpProcessor = processor; }
  ...
  private:
    bool isTagAllowedInMode(const QString &tagName, TMXPMode mode) const {
      ...
      static const QSet<QString> openModeTags = {
          "B",         "BOLD", "STRONG",    "I",  "ITALIC", "EM", "U",
          "UNDERLINE", "S",    "STRIKEOUT", "C",  "COLOR",  "H",  "HIGH",
          "FONT",      "NOBR", "P",         "BR", "SBR"};
...
private slots:
  void testSendTagBlockedInOpenMode() {
    ...
    std::string input =
        "\033[0z<SEND href=\"dangerous command\">click me</SEND>";
